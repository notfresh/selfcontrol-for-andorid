...
本项目开源免费，代码托关于 
- https://github.com/notfresh/selfcontrol-for-andorid (访问不稳定)
- https://gitee.com/notfresh/selfcontrol-for-andorid 

因为个人精力有限，目前只有安卓版的应用。

对实现技术感兴趣的可自行研究，自行编译和安装（下文有编译说明），或者提需求优化代码，感谢！  

因为App还没有上架，一个人弄出来的，请大家自行按需取用。
...
> 📖 **想了解详细的技术实现原理？** 请查看[技术原理详解](https://gitee.com/notfresh/selfcontrol-for-andorid/blob/master/dev.md#技术原理详解)
...
如何自己编译：[编译说明](https://gitee.com/notfresh/selfcontrol-for-andorid/blob/master/package.md)

## 开发文档

更多技术细节和开发文档记录请查看 `dev-docs/` 目录。
